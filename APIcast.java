...
public class APIcast{
    ...
    /**
     * creates service groups based on how their rules need to be validated
     * for example normally they would be all distinct
     * with path routing they would be grouped by same host
     * with path routing only they would be grouped all together
     * 
